...
export const FooterCard = () => {
  return (
    <div className="bg-primary-card p-7 flex flex-col justify-center items-center rounded-lg drop-shadow-footer mb-12 md:w-9/12 md:mx-auto lg:mb-16 lg:w-2/3">
      <h1 className="font-extrabold text-2xl font-roboto text-center mb-4 lg:w-3/5">Start upgrading your skills free for this month</h1>
      ...
      <div className="w-full md:flex justify-center items-center gap-x-4 md:w-1/2">
        <button className="block rounded bg-[#00000040] w-full md:mb-0 mb-4 py-2.5 text-white">Try Yourself</button>
...
export const FooterLink = () => {
  return (
    <div className="flex justify-between items-center text-icon py-8 px-4 border-y md:border-none md:p-0 md:m-0 border-icon text-2xl md:text-xl md:gap-x-4 mb-10">
      <a href="https://web.facebook.com/profile.php?id=100073858291280  " target="_blank"><FaFacebook /></a>
      <a href="https://instagram.com/ragilsg_164" target="_blank"><FaInstagram /></a>
      <a href="https://linkedin.com/in/pujiragil/" target="_blank"><FaLinkedin /></a>
      <a href="https://github.com/pujiragil/" target="_blank"><FaGithub /></a>
      <a href="https://t.me/Ragilsg" target="_blank"><FaTelegram /></a>
    </div>
  )
}
...
export const FooterCopy = () => {
  return (
    <h1 className="text-xl font-extralight text-white text-center md:text-lg">© 2021 Copyright. <span className="text-primary font-medium  ">mecode</span></h1>
  )
}