...
export const HeroTitle = ({ text, icon, width}) => {
  return (
    <>
      {icon === 'true' ? (
        ...
        <h1 className={`text-4xl ${width} md:w-2/5 lg:w-3/4 lg:text-5xl font-medium leading-title mb-4 lg:mb-10 font-roboto`}>{text}</h1>
      )}
    </>
  )
}
