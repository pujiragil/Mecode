...
export const FaqWrapper = () => {
  return (
    <div>
      <HeroTitle text="FAQs" style="font-bold text-center mb-12" />
...
export const FaqAnswer = ({open}) => {
  return (
    <div className={`${open ? "h-fit duration-300 ease-in-out" : "h-0 overflow-hidden"} w-11/12 md:w-3/4 text-justify text-lg font-inter font-extralight`}>
      <p>Nulla lectus lectus, suscipit at posuere sit amet, imperdiet sit amet sapien. Donec ornare odio justo, ac efficitur enim fermen. Nam enim ligula, lacinia vitae venenatis quis, suscipit id augue.</p>
    </div>
  )
}